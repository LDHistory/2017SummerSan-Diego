...
public class PolarBleService extends Service {
    ...
    UUID.fromString(String.valueOf(SampleGattAttributes.BATTERY_SERVICE_UUID));

    public final static UUID UUID_BATTERY_LEVEL_MEASUREMENT =
            UUID.fromString(String.valueOf(SampleGattAttributes.BATTERY_LEVEL_UUID));
    ...
    public boolean initialize() {
        ...
        if(runtimeLogging)
		    Log.w("runtimeLogging","Successfully initialize");
