            ...
            try {
                ...
                try {
                    ...
                    for (int i = 0; i < 7; i++) {
                        ...
                        avgRR.add(Float.parseFloat(jsonArray.getJSONObject(i).getString("co")));
                        maxRR.add(Float.parseFloat(jsonArray.getJSONObject(i).getString("o3")));
                        minRR.add(Float.parseFloat(jsonArray.getJSONObject(i).getString("pm25")));
